...
public class Car extends Actor implements InterfaceListener {
	...
	// method for Approcahing(intersection #) intersection
	// method for inside intersection(intersection)
	// leaving intersection
	// cleared intersection
	// get objects in range method
	// arraylists ArrayList<object> cars = new ArrayList<car>();
	// intersection tells car if approaching, car doesn't find out
	// use interfaces somehow?
	// ARGH
	// enum usage - look it up!
